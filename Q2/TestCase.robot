...
Login Success
    ...
    Input Username In BOX    ${INPUT_USERNAME_PASS}
    Input Password In BOX    ${INPUT_PASSWORD_PASS}
    Click Login Button
...
Login Failed - Password Incorrect
    ...
    Input Username In BOX    ${INPUT_USERNAME_PASS}
    Input Password In BOX    ${INPUT_PASSWORD_FAIL}
    Click Login Button
...
Login Failed - Username Not Found
    ...
    [Tags]    Login_Feature    fail
    Input Username In BOX    ${INPUT_USERNAME_FAIL}
